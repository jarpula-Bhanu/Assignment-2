...
\large Download python code from - \href{https://github.com/jarpula-Bhanu/Assignment-2/blob/main/codes/function.py}{Python}\\Download latex code from - \href{}{Latex}
\end{minipage}}
...
\noindent Hence, the given function $f(x)$ is onto.
\vspace{5mm}
